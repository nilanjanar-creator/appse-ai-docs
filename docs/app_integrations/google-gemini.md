...
<img src="\img\credentials\google-gemini\get-api-key.png" alt="APPSeAI Google Gemini Get API Key" width="700"/>
<br/>

You can choose to create a key in a new project or an existing Google Cloud project.

<img src="\img\credentials\google-gemini\create-new-key.png" alt="APPSeAI Google Gemini Create New Key" width="700"/>
...
<img src="\img\credentials\google-gemini\copy-api-key.png" alt="APPSeAI Google Gemini Copy API Key" width="700"/>
